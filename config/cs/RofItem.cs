...
if (BitConverter.IsLittleEndian){Array.Reverse(rData, nOffset, 4);}
this.ItemName = BitConverter.ToInt32(rData, nOffset); nOffset += 4;
if (BitConverter.IsLittleEndian){Array.Reverse(rData, nOffset, 4);}
this.Type = BitConverter.ToInt32(rData, nOffset); nOffset += 4;
if (BitConverter.IsLittleEndian){Array.Reverse(rData, nOffset, 4);}
this.SubType = BitConverter.ToInt32(rData, nOffset); nOffset += 4;
if (BitConverter.IsLittleEndian){Array.Reverse(rData, nOffset, 4);}
...
RofItemRow rModel = new RofItemRow();
if (BitConverter.IsLittleEndian) { Array.Reverse(rTotalBuffer, nOffset, 4); }
...
public RofItemRow GetDataByID(int nID)
{
...
public RofItemRow GetDataByRow(int nIndex)
{
